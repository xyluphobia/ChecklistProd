...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670634, ; uint32_t jnienv_initialize_method_token (0x6001caa)
	i32 100670633, ; uint32_t jnienv_registerjninatives_method_token (0x6001ca9)
...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 52888583027436415, ; hash 0xbbe5e2d4062b7f, from name: aot-ChecklistProd.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ChecklistProd.dll.so
		ptr null; void* handle (0x0)
	}, ; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 9919361553565991235, ; hash 0x89a8a6c726f7c143, from name: ChecklistProd
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ChecklistProd.dll.so
		ptr null; void* handle (0x0)
	}, ; 247
	...
	%struct.DSOCacheEntry {
		i64 10572101382748884682, ; hash 0x92b7a631b829ceca, from name: aot-ChecklistProd
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ChecklistProd.dll.so
		ptr null; void* handle (0x0)
	}, ; 265
	...
	%struct.DSOCacheEntry {
		i64 10747088736636196517, ; hash 0x95255443f4cd56a5, from name: ChecklistProd.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ChecklistProd.dll.so
		ptr null; void* handle (0x0)
	}, ; 268
	...
	%struct.DSOCacheEntry {
		i64 12481536550176973195, ; hash 0xad37535cc45a618b, from name: libaot-ChecklistProd
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ChecklistProd.dll.so
		ptr null; void* handle (0x0)
	}, ; 320
	...
	%struct.DSOCacheEntry {
		i64 15129483992257841152, ; hash 0xd1f6b988117cc800, from name: libaot-ChecklistProd.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ChecklistProd.dll.so
		ptr null; void* handle (0x0)
	}, ; 394
...
@.env.3 = private unnamed_addr constant [37 x i8] c"9622837b-58d7-4c10-911f-d1319d1ae479\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [30 x i8] c"com.companyname.checklistprod\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [28 x i8] c"libaot-ChecklistProd.dll.so\00", align 16

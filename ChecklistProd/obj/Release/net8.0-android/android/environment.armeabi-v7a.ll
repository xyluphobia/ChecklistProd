...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 266380447, ; hash 0xfe0a49f, from name: aot-ChecklistProd
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 650849039, ; hash 0x26cb2b0f, from name: aot-ChecklistProd.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ChecklistProd.dll.so
		ptr null; void* handle (0x0)
	}, ; 66
	...
	%struct.DSOCacheEntry {
		i64 679507136, ; hash 0x288074c0, from name: libaot-ChecklistProd
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ChecklistProd.dll.so
		ptr null; void* handle (0x0)
	}, ; 70
	...
	%struct.DSOCacheEntry {
		i64 1065976540, ; hash 0x3f8982dc, from name: ChecklistProd
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ChecklistProd.dll.so
		ptr null; void* handle (0x0)
	}, ; 113
	...
	%struct.DSOCacheEntry {
		i64 2555626248, ; hash 0x9853c308, from name: ChecklistProd.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ChecklistProd.dll.so
		ptr null; void* handle (0x0)
	}, ; 284
	...
	%struct.DSOCacheEntry {
		i64 2752408333, ; hash 0xa40e6b0d, from name: libaot-ChecklistProd.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ChecklistProd.dll.so
		ptr null; void* handle (0x0)
	}, ; 312
